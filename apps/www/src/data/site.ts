export const siteMetadata = {
  name: "Livedot",
  title: "Livedot - Real-time User Visualization",
  description:
    "Livedot gives teams a fast, minimal way to watch live user activity across the world with real-time visualization and simple self-hosted deployment.",
...
export const faqItems = [
  ...
  {
    question: "How do I install Livedot?",
    answer:
  ...
  {
    question: "Is Livedot self-hosted?",
    answer:
  ...
  {
    question: "Is Livedot an analytics tool replacement?",
    answer:
  ...
  {
    question: "Does Livedot require a complex setup?",
    answer:
